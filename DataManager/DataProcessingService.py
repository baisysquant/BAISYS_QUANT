...
class DataProcessingService:
    ...
    def validate_final_report(self, final_df: pd.DataFrame) -> bool:
        ...
        is_valid, missing = data_validator.validate_required_columns(
